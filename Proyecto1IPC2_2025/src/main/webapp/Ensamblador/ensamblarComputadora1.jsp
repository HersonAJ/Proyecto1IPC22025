            ...
            <div class="row">
                ...
                <main class="col-md-9">
                    <div class="container mt-4">
                        ...
                        <form action="${pageContext.request.contextPath}/EnsamblarComputadora2Servlet" method="post">
                    ...
                    for (TipoComputadora tipo : tiposComputadoras) {%>
                            ...
                            <button type="submit" class="btn btn-primary mt-2">Obtener Detalles</button>
                        </form>
