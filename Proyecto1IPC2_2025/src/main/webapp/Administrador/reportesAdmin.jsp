                ...
                <main class="col-md-6">
                    <div class="container">
                        ...
                        <div class="list-group">
                            ...
                            <a href="${pageContext.request.contextPath}/ReportesComputadoraMasVendidaServlet" class="list-group-item list-group-item-action">Reporte de Computadora Más Vendida</a>
                            <a href="${pageContext.request.contextPath}/ReportesAdminComputadoraMenosVendidaServlet" class="list-group-item list-group-item-action">Reporte de Computadora Menos Vendida</a>
