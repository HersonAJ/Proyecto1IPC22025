            ...
            <div class="row">
                ...
                <main class="col-md-9">
                    <div class="container mt-5">
                        ...
                        <form action="${pageContext.request.contextPath}/ReportesComputadoraMasVendidaServlet" method="post" class="mt-4">
                        ...
                        <form action="${pageContext.request.contextPath}/ReportesComputadoraMasVendidaServlet" method="post">
