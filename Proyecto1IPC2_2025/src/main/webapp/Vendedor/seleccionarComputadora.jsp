            ...
            <div class="row">
                ...
                <main class="col-md-9">
                    <div class="container">
                        ...
                        <form action="${pageContext.request.contextPath}/VentaServlet" method="post" class="mt-4">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="${pageContext.request.contextPath}/EliminarDetalleServlet" method="post" style="display:inline;">
