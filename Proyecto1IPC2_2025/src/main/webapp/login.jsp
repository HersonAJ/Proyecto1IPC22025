...
<body class="d-flex justify-content-center align-items-center vh-100">
    <div class="container">
        <div class="card shadow-lg p-4" style="max-width: 400px; margin: auto;">
            ...
            <!-- Mostrar mensaje de error si hay una variable en la sesión //esto sigue siendo un comentario
            <% String error = (String) session.getAttribute("error");
               if (error != null) { %>
                <div class="alert alert-danger text-center"><%= error %></div>
                <% session.removeAttribute("error"); %> <!-- Limpiar el error después de mostrarlo //esto sigue siendo un comentario
            <% } %>
